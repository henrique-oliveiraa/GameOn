...
class Obstacle {
    ...
    constructor(private canvas: HTMLCanvasElement, private ctx: CanvasRenderingContext2D | null) {
        ...
        this.width = 100; // Define a largura do obstáculo
        this.height = 50; // Define a altura do obstáculo
    }
...
class Game {
    ...
    constructor(canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D | null) {
        ...
        this.speed = 20; // Define a velocidade inicial dos obstáculos
        ...
        this.score = 300; // Inicializa a pontuação do jogador
